...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 07 fév. 2025 à 18:31
...
(1, 2, 3, 2, 'Tetouanyyyyyyyyy', 'Tetouan', 'nbhnhhhh', 2, 0, 0, 0, 0, '2025-01-24 16:14:35', '2025-02-07 12:29:07', NULL, 'http://localhost:3000/uploads/1738838381187-IMGL9752.jpg');
...
--
-- Déchargement des données de la table `activity_hours`
--

INSERT INTO `activity_hours` (`id`, `activity_id`, `day_of_week`, `opening_time`, `closing_time`, `created_at`, `is_closed`) VALUES
(1, 1, 'Monday', '00:00:00', '00:00:00', '2025-01-27 13:28:06', 1),
(2, 1, 'Tuesday', '06:00:00', '20:00:00', '2025-01-27 13:28:06', 0),
(3, 1, 'Wednesday', '07:00:00', '17:00:00', '2025-01-27 13:28:06', 0),
(4, 1, 'Thursday', '07:00:00', '17:00:00', '2025-01-27 13:28:06', 0),
(5, 1, 'Friday', '07:00:00', '17:00:00', '2025-01-27 13:28:06', 0),
(6, 1, 'Saturday', '07:00:00', '17:00:00', '2025-01-27 13:28:06', 0),
(7, 1, 'Sunday', '00:00:00', '00:00:00', '2025-01-27 13:28:06', 1);
...
INSERT INTO `activity_images` (`image_id`, `activity_id`, `image_url`, `created_at`) VALUES
(7, 1, 'http://localhost:3000/uploads/1738058091172-tÃ©lÃ©chargement (2).jpg', '2025-01-28 09:54:51'),
(13, 1, 'http://localhost:3000/uploads/1738065382308-bgMarrakech.jpg', '2025-01-28 11:56:22');
...
INSERT INTO `menus` (`id`, `restaurant_id`, `type_menu_id`, `nom`, `description`, `prix`, `imageplat`) VALUES
(1, 1, 1, 'hhhhhhhhhhhhhhhhhhh', 'huuuuuuuuuuuuuuuuuuu', 250.00, NULL);
...
CREATE TABLE `piscines` (
  `id` int(11) NOT NULL,
  `activity_id` int(11) NOT NULL,
  `type_piscine` varchar(50) DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `deleted_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Structure de la table `piscines_services`
--

CREATE TABLE `piscines_services` (
  `id` int(11) NOT NULL,
  `piscine_id` int(11) NOT NULL,
...
INSERT INTO `restaurants` (`id`, `activity_id`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 1, '2025-02-06 16:44:19', '2025-02-06 16:44:19', NULL);
...
--
-- Structure de la table `salons_beaute`
--

CREATE TABLE `salons_beaute` (
  `id` int(11) NOT NULL,
  `activity_id` int(11) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
...
--
-- Structure de la table `salons_services`
--
...
--
-- Structure de la table `services_piscine`
--

CREATE TABLE `services_piscine` (
  `id` int(11) NOT NULL,
  `nom` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Structure de la table `services_villa`
--

CREATE TABLE `services_villa` (
  `id` int(11) NOT NULL,
  `nom` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `spas` (`id`, `activity_id`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 1, '2025-02-06 16:53:56', '2025-02-06 16:53:56', NULL);

-- --------------------------------------------------------

--
-- Structure de la table `spas_soins`
--

CREATE TABLE `spas_soins` (
  `id` int(11) NOT NULL,
  `spa_id` int(11) NOT NULL,
  `type_soin_id` int(11) NOT NULL,
  `duree` int(11) DEFAULT NULL,
  `prix` decimal(10,2) DEFAULT NULL,
  `description` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Déchargement des données de la table `spas_soins`
--

INSERT INTO `spas_soins` (`id`, `spa_id`, `type_soin_id`, `duree`, `prix`, `description`) VALUES
(1, 1, 1, 55, 250.00, NULL);
...
INSERT INTO `types_soins` (`id`, `nom`) VALUES
(1, 'test');
...
--
-- Structure de la table `villas_services`
--

CREATE TABLE `villas_services` (
  `id` int(11) NOT NULL,
...
--
-- Index pour la table `piscines_services`
--
ALTER TABLE `piscines_services`
  ADD PRIMARY KEY (`id`),
  ADD KEY `piscine_id` (`piscine_id`),
...
--
-- Index pour la table `salons_beaute`
--
ALTER TABLE `salons_beaute`
  ADD PRIMARY KEY (`id`),
  ADD KEY `activity_id` (`activity_id`);

--
-- Index pour la table `salons_services`
--
...
--
-- Index pour la table `services_piscine`
--
ALTER TABLE `services_piscine`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `nom` (`nom`);

--
-- Index pour la table `services_villa`
--
ALTER TABLE `services_villa`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `nom` (`nom`);
...
--
-- Index pour la table `spas_soins`
--
ALTER TABLE `spas_soins`
  ADD PRIMARY KEY (`id`),
  ADD KEY `spa_id` (`spa_id`),
  ADD KEY `type_soin_id` (`type_soin_id`);
...
--
-- Index pour la table `types_soins`
--
ALTER TABLE `types_soins`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `nom` (`nom`);
...
--
-- Index pour la table `villas_services`
--
ALTER TABLE `villas_services`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT pour la table `piscines_services`
--
ALTER TABLE `piscines_services`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT pour la table `salons_beaute`
--
ALTER TABLE `salons_beaute`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `salons_services`
--
ALTER TABLE `salons_services`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT pour la table `services_piscine`
--
ALTER TABLE `services_piscine`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `services_villa`
--
ALTER TABLE `services_villa`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT pour la table `spas_soins`
--
ALTER TABLE `spas_soins`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT pour la table `types_soins`
--
ALTER TABLE `types_soins`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT pour la table `type_menu`
--
ALTER TABLE `type_menu`
...
--
-- AUTO_INCREMENT pour la table `villas_services`
--
ALTER TABLE `villas_services`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `excursions`
  ADD CONSTRAINT `excursions_ibfk_1` FOREIGN KEY (`activity_id`) REFERENCES `activities` (`activity_id`) ON DELETE CASCADE;
...
ALTER TABLE `menus`
  ...
  ADD CONSTRAINT `menus_ibfk_2` FOREIGN KEY (`type_menu_id`) REFERENCES `type_menu` (`id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `piscines`
--
ALTER TABLE `piscines`
  ADD CONSTRAINT `piscines_ibfk_1` FOREIGN KEY (`activity_id`) REFERENCES `activities` (`activity_id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `piscines_services`
--
ALTER TABLE `piscines_services`
  ADD CONSTRAINT `piscines_services_ibfk_1` FOREIGN KEY (`piscine_id`) REFERENCES `piscines` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `piscines_services_ibfk_2` FOREIGN KEY (`service_id`) REFERENCES `services_piscine` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `restaurants`
  ADD CONSTRAINT `restaurants_ibfk_1` FOREIGN KEY (`activity_id`) REFERENCES `activities` (`activity_id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `salons_beaute`
--
ALTER TABLE `salons_beaute`
  ADD CONSTRAINT `salons_beaute_ibfk_1` FOREIGN KEY (`activity_id`) REFERENCES `activities` (`activity_id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `salons_services`
--
ALTER TABLE `salons_services`
  ADD CONSTRAINT `salons_services_ibfk_1` FOREIGN KEY (`salon_id`) REFERENCES `salons_beaute` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `salons_services_ibfk_2` FOREIGN KEY (`service_id`) REFERENCES `services_beaute` (`id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `spas`
--
ALTER TABLE `spas`
  ADD CONSTRAINT `spas_ibfk_1` FOREIGN KEY (`activity_id`) REFERENCES `activities` (`activity_id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `spas_soins`
--
ALTER TABLE `spas_soins`
  ADD CONSTRAINT `spas_soins_ibfk_1` FOREIGN KEY (`spa_id`) REFERENCES `spas` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `spas_soins_ibfk_2` FOREIGN KEY (`type_soin_id`) REFERENCES `types_soins` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `villas`
  ADD CONSTRAINT `villas_ibfk_1` FOREIGN KEY (`activity_id`) REFERENCES `activities` (`activity_id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `villas_services`
--
ALTER TABLE `villas_services`
  ADD CONSTRAINT `villas_services_ibfk_1` FOREIGN KEY (`villa_id`) REFERENCES `villas` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `villas_services_ibfk_2` FOREIGN KEY (`service_id`) REFERENCES `services_villa` (`id`) ON DELETE CASCADE;
COMMIT;
